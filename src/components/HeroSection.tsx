    ...
    <section className="relative bg-gradient-to-br from-blue-50 via-white to-purple-50 py-20 lg:py-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          {/* Statistics */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto mb-12">
            ...
            <div
              className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 shadow-lg cursor-pointer hover:shadow-xl transition-shadow"
              onClick={() => setDisorderDialogOpen(true)}
            >
              <div className="flex items-center justify-center mb-3">
              ...
              <div className="text-gray-600">Disordered Proteins</div>
